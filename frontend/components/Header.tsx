...
export function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 h-16 bg-blue-100 shadow-md z-50 flex items-center px-4">
      <img src="https://raw.githubusercontent.com/microsoft/fluentui-emoji/main/assets/Beaming%20face%20with%20smiling%20eyes/3D/beaming_face_with_smiling_eyes_3d.png" alt="HappyShot" className="w-8 h-8 mr-2" />
